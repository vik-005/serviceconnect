...
const MapView: React.FC<MapViewProps> = ({ providers, userLocation, radius, activeProviderId }) => {
  ...
  return (
    <div className="h-full w-full relative z-0">
      ...
      >
        <TileLayer
          attribution={process.env.NEXT_PUBLIC_MAPBOX_TOKEN ? '&copy; <a href="https://www.mapbox.com/">Mapbox</a>' : '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}
